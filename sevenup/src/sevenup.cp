...
int main() {
    cout << "List contains only numbers above 7: " << (ProcessArgs(10, 11, 14, 8) ? "True" : "False") << endl << endl;
    cout << "List contains only numbers above 7: " << (ProcessArgs(10, 3, 6) ? "True" : "False") << endl;;
    return 0;
};// main end